    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settlement_report', models.DateField(blank=True, null=True)),
                ('close_record', models.DateField(blank=True, null=True)),
                ('report_date', models.DateField(blank=True, null=True)),
                ('addition', models.CharField(blank=True, max_length=2310, null=True)),
                ('url_1', models.CharField(blank=True, max_length=2310, null=True)),
                ('url_2', models.CharField(blank=True, max_length=2310, null=True)),
